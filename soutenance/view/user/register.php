        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="employer.php">Nouvel employer</a></li>
...
<?php 
    if(isset($_POST['envoyer'])) {
        ...
        $email=$_POST['email'];
        $numero=$_POST['numero'];
        $sql="INSERT INTO utilisateur(nom_user, prenom_user, password_user, email, numero) VALUES ('$nom','$prenom','$password','$email','$numero')";
